package groupinfra.christn.geolocindoor.utils;
...
/**
 * Created by christn on 09/06/2016.
 */


public class IotSubscriber {
    private static final String TAG = "IotSubscriber";
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT_PREFIX = "A1K76JXCLH0WTQ";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "<us-east-1:bfbc3674-0d7e-41fe-80b4-64c957c5d455>";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "Policy_Geoloc";
    ...
    // The IoT Locator Topic
    private static final String MQTT_LOCATION_TOPIC = "$aws/things/Location/shadow/update";
    ...
    public IotSubscriber(Context context, Listener listener) {
        mContext = context;
        mListener = listener;
            ...
            mqttManager.connect(mqttKeyStore, new AWSIotMqttClientStatusCallback() {
                ...
                public void onStatusChanged(final AWSIotMqttClientStatus status,
                    ...
                    if (status == AWSIotMqttClientStatus.Connecting) {
                        ...
                        subscribeToTopic(MQTT_LOCATION_TOPIC);
...
/*private void publishData (String message, String topic, AWSIotMqttQos qos0){
        Log.d(TAG, "Mqtt topic = " + topic);

        try {
            mqttManager.publishData(message, topic, AWSIotMqttQos.QOS0);
        }
